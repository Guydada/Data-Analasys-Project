...
as_tibble(df_2021)
as_tibble(df_emiss)
#TODO add population df, select columns
...
#TODO change column names to be same in all data, and some are imported wrong

#TODO population country names to be the same

#TODO add column total diff for 50 years, 40 years : until 10 years
